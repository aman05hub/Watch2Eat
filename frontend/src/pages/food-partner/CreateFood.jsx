...
const onFileChange = (e) =>{
    ...
    const onDrop = (e) =>{
        ...
        if(!file) { return;}
        if(!file.type.startsWith('video/')){ setFileError('Plase select a valid video file '); return}
        setFileError('');
        setVideoFile(file);
    };
    const onDragOver = (e) =>{
                ...
                <form className="create-food-form" onSubmit={onSubmit}>
                    <div className="field-group">
                        ...
                        <div
                            ...
                            >  
                                <div className="file-dropzone-inner">
                                    <svg className="file-icon" with="32" height="32" viewBox="0 0 24 24" fill="none" aria-hidden="true">
                        ...
                        {videoFile && (
                            <div className="file-chip" aria-live="polite">
                                ...
                                <div className="file-chip-action">
                    ...
                    {videoURL && (
                        <div className="video-preview">
                            <video className="video-preview" src={videoURL} controls playsInline preload="metadata" />
                        </div>
                    )}
                    ...
                    <div className="form-action">
                        <button className="btn-primary" type="submit" disabled={isDisabled}>Save Food</button>
                    </div>
                </form>
            </div>
        </div>
